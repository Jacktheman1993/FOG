...
CREATE TABLE IF NOT EXISTS `useradmin`.`Orders` (
  ...
  `Shed` TINYINT(4) NOT NULL default false,
  `Status` TINYINT(4) NOT NULL default false,
...
(1,500,800, 250, false,false, 1),
(2,400,600, 250,true,false, 2),
(3, 400, 1000, 250,false,false, 2);
